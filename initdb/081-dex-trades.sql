-- initdb/081-dex-trades.sql
-- Phase 2: Trades Pipeline, Pool State, Token Holder Stats
-- Requires: 080-dex-foundation.sql (dex schema + enums + pools)

-- ============================================================
-- 1. dex.trades — Unified Trade History
-- ============================================================
CREATE TABLE IF NOT EXISTS dex.trades (
    ...
    UNIQUE (tx_hash, source_kind, msg_index, event_index)
);
...
CREATE INDEX IF NOT EXISTS idx_dex_trades_created   ON dex.trades (created_at DESC);
...
-- ============================================================
-- 3. dex.token_holders_stats — Aggregated Holder Counts (Renamed)
-- ============================================================
